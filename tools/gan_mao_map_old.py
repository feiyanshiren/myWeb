...
te_map = {
    "风寒感冒": ["鼻塞", "声重", "喷嚏", "流清涕", "恶寒", "周身酸痛",
               "咳嗽", "痰白质稀", "舌苔薄白", "脉浮紧", "不发热",
               "微发热"],
    "风热感冒": ["鼻塞", "喷嚏", "流稠涕", "发热", "高热", "咳嗽",
               "痰稠", "舌苔薄黄", "脉浮数", "出汗", "咽痛", "微恶风",
               "口干"],
    "暑湿感冒": ["发热", "出汗", "出汗不解热", "鼻塞", "流浊涕", "头昏",
               "头重", "胀痛", "身重倦怠", "心烦", "口渴", "胸闷",
               "欲呕", "尿短赤", "舌苔黄腻", "脉濡数"],
    ...
    "时行感冒": ["高热", "全身症状重", "体温39-40度", "全身酸痛", "鼻塞",
               "流涕", "咽痛", "干咳", "咳血", "气急", "唇甲青紫",
               "头昏", "惊厥"],
    "气虚感冒": ["恶寒重", "发热不高", "鼻塞", "流涕", "头痛", "无汗",
               "体肢乏力", "咳嗽", "咳痰无力", "舌苔薄白淡", "脉浮"],
    "阴虚感冒": ["身热", "手足心热", "微恶寒", "少汗", "头昏", "心烦",
               "口干", "干嗽", "少痰", "鼻塞", "流涕", "舌红少苔", "脉细数"]
}
...
vectorizer = HashingVectorizer(n_features=65)
